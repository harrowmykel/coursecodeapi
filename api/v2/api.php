...
header('Access-Control-Allow-Origin: *');
  ...
  define('ADDR', "http://".$_SERVER["SERVER_NAME"]."/arosoftapi/coursecode/");



//new changes...fn getspreadsheet, rw_url;
//addzip folder
//add constant addr.
//edit create new. verified
  // allneed, index.php
  ...
  require_once("php-zip-master/src/zip.php");
  ...
  if ($hasBeenCheck){
    ...
    switch($req){
      ...
      case "sndmsg":
        ...
        break;
      case "rtrnnewmsgs":
        release(getNewMessages());   
        break; 
      case "fetchmsg":
        release(getMessageLists());   
        break;
      case "fetchallmsg":
        release(getMessages());   
        break; 
      ...
      case "addwatchlist":
        $ass=new Assignment();
        release($ass->addwatchlist());   
        break; 
      case 'rmvwatchlist':
        $ass=new Assignment();
        release($ass->rmvWatchlist());  
        break;
      case 'getWatchlists':
        $ass=new Assignment();
        release($ass->getwatchlists());  
        break;
      default:
        release(undefReq());
        break;
